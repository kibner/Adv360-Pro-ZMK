...
cp -f build/left/compile_commands.json ./compilation_databases/left/compile_commands.json && cp -f build/right/compile_commands.json ./compilation_databases/right/compile_commands.json
